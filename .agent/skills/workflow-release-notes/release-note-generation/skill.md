...
Generate professional release notes by collecting merged PRs, requesting AI code reviews, grouping by label, and producing user-facing summaries.
...
- Request AI code reviews for milestone PRs
...
- AI code review enabled for the org/repo
...
| Empty AISummary | Request AI reviews first, then re-run dump |
