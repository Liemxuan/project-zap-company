...
description: Refactor high-complexity React components. Use when complexity is high or lineCount > 300, when the user asks for code splitting, hook extraction, or complexity reduction; avoid for simple/well-structured components or third-party wrappers.
---
...
> **ZAP Design Engine Tech Stack**: Next.js 15.1.6 + React 19 + TypeScript 5.8.2 + Tailwind CSS 3.4.1 + Zustand 5.0.10
> **Note**: The examples below reference the Dify codebase structure. Adapt patterns to ZAP Design Engine's Next.js App Router structure (`app/` directory, `@/` imports).
> **Complexity Threshold**: Components with high complexity (many nested conditionals, large state) should be refactored before testing.
...
**Convention**: Use centralized service hooks or create custom data hooks.
...
**Convention**: Modals should be extracted with their state management.
...
**Convention**: Use standardized form patterns.
...
## Component-Specific Refactoring Guidelines
