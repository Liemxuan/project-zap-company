...
* **Asset Flow:** Stitch generates to `queue/` -> Validate -> Move to target directory.
* **Navigation Strategy:**
...
* [x] `index` - Homepage with hero and featured collections.
* [x] `collections` - Overview of furniture categories.
* [x] `about` - Our story and craftsmanship philosophy.
* [ ] `contact` - Contact form and showroom locations.
