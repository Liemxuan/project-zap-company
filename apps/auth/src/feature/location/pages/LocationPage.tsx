...
export function LocationPage({ merchant }: Props) {
  ...
  const filterGroups: FilterGroup[] = [
    ...
    },
    {
      ...
      options: [
        { id: '1', label: t('type_store', 'Store'), selected: filters.location_type_id?.includes('1') },
        { id: '2', label: t('type_warehouse', 'Warehouse'), selected: filters.location_type_id?.includes('2') },
      ]
    }
  ];
