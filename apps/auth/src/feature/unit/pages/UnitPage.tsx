...
import { UnitTableExpanded, type UnitFilters } from '../components/UnitTableExpanded';
...
export function UnitPage({ merchant }: Props) {
  const { inspectorState, setInspectorState } = useTheme();
  const { t, lang, loading: tLoading } = useTranslation('unit');
  ...
  const inspectorContent = (
    <Inspector title="UNITS" width={320}>
