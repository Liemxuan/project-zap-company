...
import { CategoryTableExpanded, type CategoryFilters } from '@/feature/category/components/CategoryTableExpanded';
import { useCategories } from '@/feature/category/hooks/use-categories';
import { loadTranslations, t as translate } from '@/lib/i18n';
import type { SupportedLang } from '@/const';

// ── Page ─────────────────────────────────────────────────────────────────────

export default function AuthCategoriesPage() {
    ...
    useEffect(() => {
        loadTranslations(lang, 'category')
    ...
    const inspectorContent = (
        <Inspector title={t('inspector_title', 'CATEGORIES LAB')} width={320}>
    ...
    return (
        <div className="flex h-screen w-full bg-layer-canvas overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                <ThemeHeader
                    title={t('title', 'categories assembly')}
                    breadcrumb={`zap auth / ${theme} / category vault`}
