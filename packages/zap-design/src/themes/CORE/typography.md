...
The Core theme enforces a 3-tier system for font families, rigidly bound by M3 roles:

- **Primary Font:** `var(--font-roboto)` (Sans-serif)
  *Scope:* Display, Headline, Title. Used for sharp, professional authority.
...
The Core theme automatically applies structural casing overrides to enforce alignment and structure, primarily forcing `uppercase` onto smaller labels and titles.
- **TitleMedium / TitleSmall:** Forced `uppercase`.
