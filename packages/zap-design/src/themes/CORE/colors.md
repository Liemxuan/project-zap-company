# Color Data Dictionary (Core Theme)

> [!IMPORTANT]
> **ZAP-AUDIT DIRECTIVE:** This file is the absolute source of truth for Color configuration in the Core theme. The `zap-audit` skill must evaluate all components against these rules.
