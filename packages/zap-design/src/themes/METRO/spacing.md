# Spacing Data Dictionary (Metro Theme)

> [!IMPORTANT]
> **ZAP-AUDIT DIRECTIVE:** This file is the absolute source of truth for Spacing configuration in the Metro theme. The `zap-audit` skill must evaluate all components against these rules.
