...
export const MasterVerticalShell = ({
    children,
    breadcrumbs = [
        { label: 'My Sites' },
        { label: 'ZAP.vn' },
            ...
            window.requestAnimationFrame(() => {
                ...
                if (type === 'sidebar') {
                    if (newWidth < 120) {
                        ...
                        setSidebarWidth(Math.min(Math.max(newWidth, 180), 500));
                    }
                } else {
                    if (newWidth < 100) {
    ...
    return (
        <div className="h-screen flex flex-col bg-layer-canvas text-theme-base antialiased overflow-hidden select-none">
            ...
            <main className="flex-1 flex overflow-hidden bg-layer-canvas relative">
                ...
                <VerticalNav width={sidebarWidth} isCollapsed={isSidebarCollapsed} />

                {/* Resize Divider Decoration */}
                <div
