...
export const TaxInspector: React.FC<TaxInspectorProps> = ({
    ...
    return (
        <Inspector title={t.label_inspector || "TAX INSPECTOR"} width={320}>
            <div className="flex flex-col gap-0 w-full px-4 pt-4">
                ...
                >
                    <AccordionItem value="filters" className="border-none m-0">
                        <AccordionTrigger className="px-4 py-3 flex items-center gap-2 rounded-lg bg-layer-base hover:bg-layer-base/80 font-dev text-transform-tertiary text-[11px] tracking-widest text-on-surface font-bold transition-colors m-0 w-full min-w-0">
                            <div className="flex items-center gap-2 overflow-hidden flex-1 text-left min-w-0">
                                ...
                                <span className="truncate text-transform-tertiary">{t.label_filters || "FILTERS"}</span>
                            </div>
                        </AccordionTrigger>
