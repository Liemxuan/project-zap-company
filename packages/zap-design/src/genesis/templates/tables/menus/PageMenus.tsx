...
// Hooks
import { useMenus } from '@/hooks/menu/use-menus';

// Components
import { getColumns } from './components/columns';
import { getFilterGroups, MENU_LABELS } from './components/filters';
import { MenuInspector } from './components/inspector';

/**
 * Menu Template
 * Route: /design/[theme]/organisms/menus
 */
export default function PageMenusTemplate() {
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-layer-base/50 relative">
                <div className="h-14 border-b border-border bg-layer-base flex items-center px-6 justify-between shrink-0 shadow-sm z-10 relative">
                    <div className="flex items-center text-xs gap-1 font-dev text-transform-tertiary">
                        ...
                        <span className="font-bold text-on-surface uppercase tracking-widest">Menus</span>
                    </div>
                </div>
        ...
        return (
            <div className="flex h-screen w-full bg-layer-canvas overflow-hidden font-sans">
                ...
                <div className="flex-1 flex flex-col min-w-0 bg-transparent relative">
                    <ThemeHeader title="Menus" badge={null} />
    ...
    return (
        <ComponentSandboxTemplate
            ...
            tier="L6 LAYOUT"
            status="Verified"
            filePath="src/genesis/templates/tables/menus/PageMenus.tsx"
            importPath="@/genesis/templates/tables/menus/PageMenus"
        ...
        >
            <div className="w-full flex-1 flex items-center justify-center pt-8">
                <CanvasDesktop
                    ...
                    fullScreenHref={`/design/${activeTheme}/organisms/menus?fullscreen=true`}
                >
                    {mockShellLayout}
                </CanvasDesktop>
            </div>
