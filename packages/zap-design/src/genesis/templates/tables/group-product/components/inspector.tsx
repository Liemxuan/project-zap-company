...
interface GroupProductInspectorProps {
...
/**
 * Inspector component for Group Product page
 */
export const GroupProductInspector: React.FC<GroupProductInspectorProps> = ({
    inspectorState,
    setInspectorState,
    filterGroups,
    onFilterToggle
    ...
    return (
        <div className="h-full border-l border-border bg-layer-panel hidden md:flex flex-col shrink-0 z-20 relative">
            <Inspector title="GROUP PRODUCT LAB" width={320}>
