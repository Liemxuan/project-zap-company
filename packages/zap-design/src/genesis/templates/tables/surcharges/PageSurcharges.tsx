...
import surchargeEn from '@/locale/surcharge/en';
import surchargeVi from '@/locale/surcharge/vi';
...
export default function PageSurchargesTemplate() {
    ...
    const t = lang === 'vi' ? surchargeVi : surchargeEn;
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-layer-base/50 relative">
                <div className="h-14 border-b border-border bg-layer-base flex items-center px-6 justify-between shrink-0 shadow-sm z-10 relative">
                    <div className="flex items-center text-xs gap-1 font-dev text-transform-tertiary">
                        <span className="opacity-50 text-transform-tertiary tracking-widest">{t.nav_setup}</span>
                        <Icon name="chevron_right" size={14} className="opacity-30" />
                        <span className="font-bold text-on-surface text-transform-tertiary tracking-widest">{t.nav_surcharges}</span>
                    </div>
                </div>
    ...
    return (
        <ComponentSandboxTemplate
            componentName={t.title_surcharges}
            tier="L6 LAYOUT"
            status="Verified"
