...
export default function ActivitiesTemplate() {
    ...
    const sidebarContent = (
        <nav className="flex flex-col gap-1 w-full font-body text-transform-secondary">
            <GenesisButton visualStyle="solid" className="justify-start gap-3 w-full bg-primary-container text-on-primary-container">
                <Activity className="size-4" />
                Audit Logs
            </GenesisButton>
            <GenesisButton visualStyle="ghost" className="justify-start gap-3 w-full text-on-surface-variant hover:text-on-surface">
        ...
        <SettingsLayout sidebar={sidebarContent}>
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                    ...
                    <GenesisButton visualStyle="outline" className="gap-2 border-border text-on-surface">
                ...
                <Card className="p-0 overflow-hidden flex flex-col border border-border">
                    <div className="p-4 border-b border-border bg-surface-container-highest flex gap-2">
                        <GenesisButton visualStyle="solid" className="bg-primary text-on-primary h-8 text-xs">All Events</GenesisButton>
                        <GenesisButton visualStyle="ghost" className="text-on-surface-variant hover:text-on-surface h-8 text-xs">Extraction</GenesisButton>
                        <GenesisButton visualStyle="ghost" className="text-on-surface-variant hover:text-on-surface h-8 text-xs">Security</GenesisButton>
                        <GenesisButton visualStyle="ghost" className="text-on-surface-variant hover:text-on-surface h-8 text-xs">System</GenesisButton>
                    </div>
