                ...
                <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    <Card className="p-6 flex flex-col gap-6">
                        ...
                        <div className="pt-4 border-t border-border">
                            <GenesisButton visualStyle="solid" className="bg-primary text-on-primary font-display text-transform-primary">
                                Save changes
                            </GenesisButton>
                        </div>
                    </Card>
                ...
                <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    <Card className="p-6 flex flex-col gap-6">
                        <div className="flex items-start justify-between">
                            ...
                            <GenesisButton visualStyle="outline" className="border-border text-on-surface">Enabled</GenesisButton>
                        </div>
                        ...
                        <div className="pt-4 border-t border-border flex items-start justify-between">
                            ...
                            <GenesisButton visualStyle="ghost" className="text-error hover:bg-error-container">Revoke All</GenesisButton>
                        </div>
                    </Card>
                </div>
            )}
