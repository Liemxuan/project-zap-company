            ...
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <Card className="p-0 overflow-hidden flex flex-col md:flex-row border-primary/20">
                    ...
                    <div className="w-full md:w-[240px] bg-surface-container-highest p-6 flex flex-col justify-center items-start gap-3 border-l md:border-t-0 border-border">
                        <GenesisButton visualStyle="solid" className="w-full bg-primary text-on-primary gap-2">
                            <Zap className="size-4" /> Upgrade Plan
                        </GenesisButton>
                        <GenesisButton visualStyle="ghost" className="w-full text-error hover:bg-error-container">
                            Cancel Subscription
                        </GenesisButton>
                    </div>
                </Card>
                ...
                <Card className="p-6 flex flex-col gap-6 mt-2">
                    <div className="flex items-center justify-between">
                        ...
                        <GenesisButton visualStyle="outline" className="h-8 border-border text-on-surface text-xs">Add Method</GenesisButton>
                    </div>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell className="text-right">
                                        <GenesisButton visualStyle="ghost" className="h-8 w-8 p-0 text-on-surface-variant hover:text-on-surface">
