...
export const Heading = ({ level = 1, children, className = '', style, transform }: TitleProps) => {
    ...
    // When transform is explicitly set, use that class. Otherwise let CSS --heading-transform control it.
