...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showClose && (
        <Button variant="ghost" size="icon" className="absolute right-6 top-6 h-8 w-8 rounded-full" asChild>
