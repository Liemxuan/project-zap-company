...
const accordionTriggerVariants = cva(
    'flex flex-1 items-center justify-between py-4 gap-2.5 text-on-surface text-transform-primary font-display text-transform-primary font-medium transition-all [&[data-state=open]>svg]:rotate-180 cursor-pointer',
    {
        variants: {
            variant: {
                default: '',
