...
import { Check, ChevronDown, Filter, MoreHorizontal, Edit, Trash2, Eye, Plus } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell className="w-24 pr-7 py-2.5 text-right">
                  ...
                  <TableHead className="w-24 pr-7 text-right bg-layer-panel">
                    <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                      ...
                      <PopoverContent className="w-56 p-0 bg-surface shadow-2xl border border-outline rounded-xl" align="end" sideOffset={8}>
                        <div className="p-3">
                          <p className="font-dev text-[10px] text-muted-foreground font-semibold tracking-wide uppercase">Select Columns</p>
                        </div>
