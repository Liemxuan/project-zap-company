...
export const TypographyCanvasStage = ({ themeData }: TypographyWildPreviewProps) => {
    ...
    if (theme === 'fun') {
        return (
            <Wrapper identity={{ displayName: "Fun Mode Preview", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Atom/View" }} className="w-full">
                <div className="w-full relative h-[600px] bg-[#ffe6f2] border-[length:var(--card-border-width,4px)] border-brand-midnight overflow-hidden rounded-[2rem] shadow-[8px_8px_0px_0px_var(--color-brand-midnight)] font-display text-transform-primary flex items-center justify-center p-12">
                    <div className="absolute top-8 left-8 border-[length:var(--card-border-width,4px)] border-brand-midnight w-24 h-24 rounded-full flex items-center justify-center font-black text-4xl rotate-12 bg-[#00ffff] z-20 drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">?!</div>
                    <div className="absolute bottom-8 right-8 bg-[#ff007f] text-white font-black px-4 py-2 border-[length:var(--card-border-width,4px)] border-brand-midnight -rotate-12 rounded-full z-20 text-xl drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">WOW!</div>
                    ...
                    <div className="relative w-full max-w-4xl flex flex-col items-center justify-center text-center z-10" style={{ lineHeight }}>
                        <Wrapper identity={{ displayName: "Bouncy Label", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }}>
                            <div className="bg-white border-[length:var(--card-border-width,4px)] border-brand-midnight rounded-full px-8 py-2 mb-8 drop-shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-transform" style={{ transform: `rotate(${3 + tilt}deg)` }}>
                                <span className="font-display text-transform-primary font-black text-2xl text-brand-midnight text-transform-secondary" style={{ letterSpacing: `${0.2 + letterSpacing / 10}em` }}>Super Bouncy</span>
                            </div>
                        </Wrapper>
                        ...
                        <Wrapper identity={{ displayName: "Make It Pop Title", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }}>
                            <h2 className="text-[140px] font-black leading-[0.8] text-transform-secondary mb-16 relative transition-all duration-300 group" style={{ letterSpacing: `${0.02 + letterSpacing / 10}em` }}>
                                <span className="block text-[#ff007f] hover:rotate-2 transition-transform cursor-default" style={{ transform: `rotate(${-6 + tilt}deg)`, WebkitTextStroke: '4px var(--color-brand-midnight)', textShadow: `${8 + shadowOffset}px ${8 + shadowOffset}px 0px var(--color-brand-midnight)` }}>MAKE</span>
                                <span className="block relative z-10 text-[#00ffff] ml-12 hover:-rotate-2 transition-transform cursor-default" style={{ transform: `rotate(${6 + tilt}deg)`, WebkitTextStroke: '4px var(--color-brand-midnight)', textShadow: `${8 + shadowOffset}px ${8 + shadowOffset}px 0px var(--color-brand-midnight), ${16 + shadowOffset * 2}px ${16 + shadowOffset * 2}px 0px #ff007f` }}>IT POP</span>
                            </h2>
                        </Wrapper>
                        ...
                        <Wrapper identity={{ displayName: "Playground Banner", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }}>
                            <div className="bg-brand-yellow text-brand-midnight px-8 py-6 border-[length:var(--card-border-width,4px)] border-brand-midnight rounded-3xl -mt-12 w-4/5 mx-auto relative z-20 hover:scale-105 transition-all font-sans" style={{ transform: `rotate(${-4 + tilt}deg)`, boxShadow: `${8 + shadowOffset}px ${8 + shadowOffset}px 0 0 var(--color-brand-midnight)` }}>
                                <p className="font-sans font-black text-3xl text-transform-secondary tracking-tight leading-tight">
                        ...
                        <Wrapper identity={{ displayName: "Fun Decal", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }} className="absolute -left-12 top-1/2 -mt-4">
                            <div className="bg-brand-midnight text-white font-black px-4 py-2 border-[length:var(--card-border-width,4px)] border-white rounded-full -rotate-90 z-30 text-lg drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">FUN!</div>
                        </Wrapper>
                        <Wrapper identity={{ displayName: "Yeah Decal", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }} className="absolute -right-4 top-1/3 -mt-4">
                            <div className="bg-[#39ff14] text-brand-midnight font-black px-3 py-1 border-[length:var(--card-border-width,4px)] border-brand-midnight rounded-full rotate-45 z-30 text-xl shadow-[4px_4px_0_0_var(--color-brand-midnight)]">YEAH!</div>
                        </Wrapper>
                    </div>
                </div>
            </Wrapper>
        ...
        <Wrapper identity={{ displayName: "Wild Mode Preview", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Atom/View" }} className="w-full">
            <div className="w-full relative h-[600px] bg-layer-cover border-[length:var(--card-border-width,2px)] border-card-border overflow-hidden rounded-card selection:bg-brand-midnight selection:text-brand-cover font-display text-transform-primary flex flex-col pt-8">
                ...
                <Wrapper identity={{ displayName: "Exclamation Sticker", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }} className="absolute top-8 left-8 z-20">
                    ...
                    >
                        <span className="text-3xl font-black text-brand-midnight">!</span>
                    </motion.div>
                </Wrapper>
                ...
                >
                    ...
                    <Wrapper identity={{ displayName: "3D Stacked Title", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }}>
                        <div className="relative group perspective-1000">
                            <motion.h1
                                ...
                                className="text-8xl md:text-[140px] font-black text-transform-secondary tracking-tighter leading-[0.8]"
                            >
                                <span className="block text-white" style={{ WebkitTextStroke: '3px var(--color-brand-midnight)', textShadow: '4px 4px 0px var(--color-brand-midnight)' }}>BREAK</span>
                                <span className="block text-acid-green -mt-4 transform -rotate-2" style={{ WebkitTextStroke: '2px var(--color-brand-midnight)', textShadow: '6px 6px 0px var(--color-brand-midnight)' }}>RULES</span>
                            </motion.h1>
                        </div>
                    </Wrapper>
                    ...
                    <Wrapper identity={{ displayName: "Overlaid Black Banner", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }} className="absolute top-[65%] w-[110%] md:w-[600px] -ml-4">
                        ...
                        >
                            <h2 className="text-xl md:text-3xl font-black text-transform-secondary tracking-tight text-center leading-none">
                ...
                <Wrapper identity={{ displayName: "Scrolling Marquee Ribbon", filePath: "zap/sections/atoms/typography/wild-preview.tsx", type: "Wrapped Snippet" }} className="absolute bottom-24 left-0 right-0 w-[110%] -rotate-2 origin-left z-20">
                    <div className="overflow-hidden bg-white border-y-[length:var(--card-border-width,2px)] border-brand-midnight shadow-[4px_4px_0px_rgba(0,0,0,0.5)] flex whitespace-nowrap py-3">
                        <motion.div
                            className="flex whitespace-nowrap text-brand-midnight font-bold tracking-widest text-transform-secondary text-sm"
                            animate={{ x: ["0%", "-50%"] }}
