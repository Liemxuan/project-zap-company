...
export const DraggableToolbox = ({ atomId, settings, onUpdate, onClose, onSave, onMakeGlobal }: DraggableToolboxProps) => {
    ...
    const handlePointerMove = (e: React.PointerEvent) => {
        ...
        const newX = Math.max(8, Math.min(e.clientX - startPos.current.x, window.innerWidth - w - 8));
        const newY = Math.max(8, Math.min(e.clientY - startPos.current.y, window.innerHeight - h - 8));
    ...
    return (
        <div
            ref={containerRef}
            className="fixed z-[100] w-[260px] bg-theme-base border-[length:var(--card-border-width,2px)] border-brand-midnight shadow-[4px_4px_0px_0px_var(--color-brand-midnight)] flex flex-col rounded-md overflow-hidden"
        >
            {/* DRAG HANDLE */}
            <div
                ref={dragRef}
            ...
            >
                <div className="flex items-center gap-2 pl-1">
                    ...
                    <span className="text-[10px] font-dev text-transform-tertiary font-bold tracking-widest text-white">{atomId}</span>
                </div>
            ...
            <div className="flex border-b border-gray-200 bg-gray-50">
                <button
                    ...
                    className={`flex-1 py-1.5 text-[10px] font-dev text-transform-tertiary font-black tracking-widest ${activeTab === 'styling' ? 'bg-white text-brand-midnight border-b-2 border-brand-midnight' : 'text-gray-400 hover:text-brand-midnight'}`}
                >
                    Styling
                </button>
                <button
                    onClick={() => setActiveTab('effects')}
                    className={`flex-1 py-1.5 text-[10px] font-dev text-transform-tertiary font-black tracking-widest ${activeTab === 'effects' ? 'bg-white text-brand-midnight border-b-2 border-brand-midnight' : 'text-gray-400 hover:text-brand-midnight'}`}
                >
                    Effects
                </button>
            </div>
            ...
            {/* CONTROLS */}
            <div className="p-3 space-y-4 max-h-[500px] overflow-y-auto w-full font-body scrollbar-thin scrollbar-thumb-brand-midnight scrollbar-track-transparent">
                    ...
                    <>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 p-1.5 rounded">
                                <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-500 w-8 tracking-wide">SIZE</span>
                                ...
                                <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-400">px</span>
                            </div>
                        </div>
                            ...
                            {settings.box?.enabled && (
                                <div className="flex gap-2 items-center bg-gray-50 p-2 border border-gray-200 rounded">
                                    ...
                                    <div className="flex-1 flex items-center gap-2">
                                        <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-500">Padding</span>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className={`transition-opacity ${!settings.layer0.enabled ? 'opacity-30 pointer-events-none' : ''}`}>
                                <div className="flex gap-2 items-center bg-gray-50 p-2 border border-gray-200 rounded">
                                    ...
                                    <div className="flex-1 flex items-center gap-2">
                                        <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-500">Opacity</span>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className={`transition-opacity ${!settings.layer1.enabled ? 'opacity-30 pointer-events-none' : ''}`}>
                                <div className="flex gap-2 items-center bg-gray-50 p-2 border border-gray-200 rounded">
                                    ...
                                    <div className="flex-1 flex items-center gap-2">
                                        <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-500">Width</span>
                                ...
                                <div className="flex gap-2 bg-gray-50 p-2 border border-gray-200 rounded">
                                    ...
                                    <div className="flex-1 space-y-2">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-400 w-2">X</span>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-400 w-2">Y</span>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-[9px] font-dev text-transform-tertiary font-bold text-gray-400 w-2">B</span>
                ...
                {activeTab === 'effects' && (
                    <div className="space-y-4">
                        ...
                        <div className={`space-y-4 transition-opacity ${!settings.effects?.enabled ? 'opacity-30 pointer-events-none' : ''}`}>
                            {/* KINETIC TILT */}
                            <div className="space-y-1.5 border border-brand-midnight p-2 rounded relative bg-theme-base shadow-[2px_2px_0_0_var(--color-brand-midnight)]">
                                <span className="text-[9px] font-dev text-transform-tertiary font-black text-brand-midnight tracking-widest absolute -top-2 bg-white px-1">Kinetic Tilt</span>
                            ...
                            {/* CHARACTER CRUSH */}
                            <div className="space-y-1.5 border border-brand-midnight p-2 rounded relative bg-theme-base shadow-[2px_2px_0_0_var(--color-brand-midnight)]">
                                <span className="text-[9px] font-dev text-transform-tertiary font-black text-brand-midnight tracking-widest absolute -top-2 bg-white px-1">Character Crush</span>
                                <div className="pt-2 flex items-center gap-2">
                            ...
                            {/* UPPERCASE */}
                            <div className="space-y-1.5 border border-brand-midnight p-2 rounded relative bg-theme-base shadow-[2px_2px_0_0_var(--color-brand-midnight)] flex items-center justify-between">
                                <span className="text-[9px] font-dev text-transform-tertiary font-black text-brand-midnight tracking-widest">Force Casing</span>
                            ...
                            {/* ANIMATION */}
                            <div className="space-y-1.5 border border-brand-midnight p-2 rounded relative bg-theme-base shadow-[2px_2px_0_0_var(--color-brand-midnight)]">
                                <span className="text-[9px] font-dev text-transform-tertiary font-black text-brand-midnight tracking-widest absolute -top-2 bg-white px-1">Hydra Animation</span>
                                <div className="pt-2">
                                    <Select
                                        options={[
                                        ...
                                        className="w-full text-[10px] font-dev text-transform-tertiary font-black tracking-widest text-brand-midnight"
                                    />
                                </div>
                            </div>
                        </div>
            ...
            <div className="p-2 border-t border-gray-200 bg-gray-50 flex gap-2">
                <button
                    onClick={onSave}
                    className="flex-1 bg-gray-200 text-brand-midnight text-[10px] font-dev text-transform-tertiary font-black tracking-widest py-1.5 rounded hover:bg-gray-300 transition-colors"
                >
                    Done
                </button>
                {onMakeGlobal && (
                    <button
                        ...
                        className="flex-1 bg-brand-yellow text-brand-midnight text-[10px] font-dev text-transform-tertiary font-black tracking-widest py-1.5 rounded hover:brightness-95 transition-colors shadow-[2px_2px_0_0_var(--color-brand-midnight)]"
                    >
                        Sync Global
                    </button>
                )}
