...
export default function MetroProfile() {
    return (
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="flex flex-col gap-6 w-full md:w-[320px] shrink-0">
                                ...
                                <Card className="p-6 flex flex-col items-center text-center gap-4 bg-surface shadow-md">
                                    ...
                                    <div className="flex w-full gap-3 mt-2">
                                        <GenesisButton variant="flat" className="flex-1 bg-primary text-on-primary">Follow</GenesisButton>
                                        <GenesisButton visualStyle="outline" variant="flat" className="flex-1 border-border text-on-surface">Message</GenesisButton>
                                    </div>
                            ...
                            <div className="flex flex-col gap-6 grow min-w-0 mt-16 md:mt-20">
                                ...
                                <div className="flex gap-2 border-b border-border pb-px overflow-x-auto no-scrollbar">
                                    <GenesisButton visualStyle="ghost" variant="flat" className="rounded-none border-b-2 border-primary text-primary font-display text-transform-primary px-4 py-2 hover:bg-surface-variant">
                                        <Grid className="size-4 mr-2 inline" /> Activity
                                    </GenesisButton>
                                    <GenesisButton visualStyle="ghost" variant="flat" className="rounded-none border-b-2 border-transparent text-on-surface-variant font-display text-transform-primary px-4 py-2 hover:bg-surface-variant hover:text-on-surface">
                                    ...
                                    <Card className="p-6 flex flex-col gap-4">
                                        ...
                                        <div className="pl-11 pr-4">
                                            ...
                                            <div className="mt-4 p-4 rounded-btn border border-border bg-surface-container flex items-center justify-between">
                                                ...
                                                <GenesisButton visualStyle="outline" variant="flat" className="h-8 px-3 text-xs border-border">Review</GenesisButton>
                                            </div>
                                        </div>
                                    </Card>
