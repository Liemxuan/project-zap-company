                ...
                <div className="w-full max-w-sm space-y-6">
                    ...
                    <div className="bg-layer-panel rounded-[var(--radius)] p-6 shadow-card">
                        <div className="pt-6 space-y-4">
                            ...
                            <Button className="w-full font-medium" variant="flat">
                                Sign In
                            </Button>
                        </div>
                        <div className="flex flex-col gap-4 border-t border-border/50 bg-black/5 p-6 mt-2">
                            <Button visualStyle="outline" variant="flat" className="w-full border-dashed shadow-xs hover:bg-accent text-muted-foreground">
