...
import { compileFlutterTypography } from '../../../../lib/flutter-compiler';
...
export async function POST(request: Request) {
    try {
        ...
        console.log(`[ZAP PUBLISH] Saved ${theme} typography settings to disk`, settings);

        // FLUTTER SYNC HOOK
        await compileFlutterTypography(theme, body);
