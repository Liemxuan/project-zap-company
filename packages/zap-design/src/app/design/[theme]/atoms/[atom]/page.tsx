            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 px-4">
                ...
                <div className="text-center space-y-2">
                    <h2 className="text-xl font-bold text-foreground">
                        <code className="font-dev text-primary">{atomId}</code> not found
                    </h2>
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 px-4">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground max-w-md">
                        <code className="font-dev text-primary">{atomEntry.label}</code> exists in the registry
                        but isn&apos;t enabled for <strong>{themeConfig.name}</strong>.
                        Add <code className="font-dev">&quot;{atomId}&quot;</code> to <code className="font-dev">hasAtoms</code> in the registry.
                    </p>
                </div>
            </div>
        );
