 ...
 <span className="text-label-medium font-bold font-display text-transform-primary tracking-widest text-on-surface-variant text-transform-secondary text-transform-tertiary">Variant: Default (Pill Container)</span>
                        <Tabs defaultValue="account" className="w-[400px]">
                            ...
                            <TabsContent value="account" className="p-4 border border-outline-variant rounded-md mt-2 bg-layer-cover">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Make changes to your account here.</p>
                            </TabsContent>
                            <TabsContent value="password" className="p-4 border border-outline-variant rounded-md mt-2 bg-layer-cover">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Change your password here.</p>
                            </TabsContent>
                        </Tabs>
                    </div>
 ...
 <span className="text-label-medium font-bold font-display text-transform-primary tracking-widest text-on-surface-variant text-transform-secondary text-transform-tertiary">Variant: Button (Independent)</span>
                        <Tabs defaultValue="music" className="w-[400px]">
                            ...
                            <TabsContent value="music" className="p-4 border border-outline-variant rounded-md mt-2 bg-layer-panel">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Listen to music streams.</p>
                            </TabsContent>
                            <TabsContent value="podcasts" className="p-4 border border-outline-variant rounded-md mt-2 bg-layer-panel">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Listen to podcast episodes.</p>
                            </TabsContent>
                            <TabsContent value="live" className="p-4 border border-outline-variant rounded-md mt-2 bg-layer-panel">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Live broadcasts.</p>
                            </TabsContent>
                        </Tabs>
                    </div>
 ...
 <span className="text-label-medium font-bold font-display text-transform-primary tracking-widest text-on-surface-variant text-transform-secondary text-transform-tertiary">Variant: Line (Underline Focus)</span>
                        <Tabs defaultValue="overview" className="w-[400px]">
                            ...
                            <TabsContent value="overview" className="p-4 mt-2 bg-layer-dialog rounded-md">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Overview content panel.</p>
                            </TabsContent>
                            <TabsContent value="analytics" className="p-4 mt-2 bg-layer-dialog rounded-md">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Analytics graph here.</p>
                            </TabsContent>
                            <TabsContent value="reports" className="p-4 mt-2 bg-layer-dialog rounded-md">
                                <p className="text-body-small text-on-surface-variant text-transform-secondary">Downloaded reports list.</p>
                            </TabsContent>
                        </Tabs>
                    </div>
