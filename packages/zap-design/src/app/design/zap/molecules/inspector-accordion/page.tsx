                        ...
                        <div className="w-[280px] rounded-xl border border-outline-variant/50 overflow-hidden bg-layer-panel p-4 space-y-2">
                            <InspectorAccordion title="Foundation Rules" icon="security" defaultOpen={false}>
                                <ul className="space-y-2 pt-1">
                                    <li className="text-[11px] text-on-surface-variant pl-2 border-l-2 border-primary/20">Never use inline styles.</li>
                                    <li className="text-[11px] text-on-surface-variant pl-2 border-l-2 border-primary/20">Always use M3 color tokens.</li>
                                </ul>
                            </InspectorAccordion>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-[280px] rounded-xl border border-outline-variant/50 overflow-hidden bg-layer-panel">
                            ...
                            <div className="h-12 px-4 flex items-center gap-2 border-b border-outline-variant/50 shrink-0">
                                <span className="text-[11px] font-black font-display tracking-widest text-on-surface text-transform-primary">INSPECTOR</span>
                            </div>
                            <div className="p-4 space-y-2">
                                <InspectorAccordion title="Data Terminal" icon="database" defaultOpen={true}>
                                    <div className="space-y-2 pt-1">
                                        <div className="flex justify-between text-[10px] font-dev text-transform-tertiary">
                                ...
                                <InspectorAccordion title="Dynamic Properties" icon="tune" defaultOpen={true}>
                                    <div className="pt-1 text-[11px] text-on-surface-variant">No controls defined.</div>
                                </InspectorAccordion>
                                <InspectorAccordion title="Inheritance Map" icon="account_tree" defaultOpen={false}>
                                    <div className="flex flex-wrap gap-1 pt-1">
                                        <span className="px-1.5 py-0.5 bg-primary-container text-on-primary-container rounded text-[10px] font-dev text-transform-tertiary">bg-primary/10</span>
                                        <span className="px-1.5 py-0.5 bg-secondary-container text-on-secondary-container rounded text-[10px] font-dev text-transform-tertiary">font-display</span>
                                    </div>
                                </InspectorAccordion>
                                <InspectorAccordion title="Platform Context" icon="devices" defaultOpen={false}>
                                    <p className="pt-1 text-[11px] text-on-surface-variant leading-relaxed">Full-width, vertically stacked inside Inspector sidebar.</p>
                                </InspectorAccordion>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="rounded-xl border border-outline-variant/40 overflow-hidden bg-surface">
                            <div className="px-4 py-3 bg-surface-container-high border-b border-outline-variant/30 flex items-center justify-between">
                                <span className="text-sm font-black tracking-tight text-on-surface uppercase font-secondary">InspectorAccordionProps</span>
