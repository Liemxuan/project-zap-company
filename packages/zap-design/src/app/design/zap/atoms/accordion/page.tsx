...
export default function AccordionItemSandboxPage() {    const [height, setHeight] = useState([40]);
    ...
    return (
        ...
        >
            ...
            >
                <div className="w-full min-w-[320px] md:min-w-[480px] max-w-lg mx-auto pt-8 flex flex-col p-12 bg-layer-panel shadow-sm border-[length:var(--accordion-border-width)] border-outline-variant rounded-[length:var(--accordion-radius)]">
                    <Accordion type="single" collapsible value={openId || ''} onValueChange={setOpenId} className="w-full">
                        <AccordionItem value="1">
                            ...
                            <AccordionContent>
                                <p className="text-muted-foreground text-sm">Status, tier and implementation details for this component.</p>
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="2">
                            ...
                            <AccordionContent>
                                <p className="text-muted-foreground text-sm">Strict guidelines from M3 standard and ZAP rules.</p>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
