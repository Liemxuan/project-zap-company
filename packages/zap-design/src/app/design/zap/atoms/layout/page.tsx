                    ...
                    <Wrapper identity={{ displayName: "Grid Implementation", filePath: "app/debug/zap/layout/page.tsx", type: "Atom/View", architecture: "SYSTEMS // CORE" }}>
                        <div className="border border-black p-4 bg-primary/10 space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                <span className="material-symbols-outlined text-primary bg-black p-1 text-sm">code</span>
                                <h3 className="text-xs font-black uppercase tracking-tighter">Grid Implementation</h3>
                            </div>
                            <div className="space-y-2">
                                <div className="bg-white border border-black p-3">
                                    <p className="text-[10px] font-dev text-transform-tertiary text-slate-500 mb-2 border-b border-slate-200 pb-1">CSS Grid</p>
                                    <code className="text-[10px] font-dev text-transform-tertiary block text-slate-800 whitespace-pre leading-relaxed">
                                        {`.grid-container {
      display: grid;
      ...
      margin: 0 auto;
                    ...
                    <Wrapper identity={{ displayName: "Responsive Breakpoints", filePath: "app/debug/zap/layout/page.tsx", type: "Atom/View", architecture: "SYSTEMS // CORE" }}>
                        <div className="border border-black p-4 space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h3 className="text-xs font-black uppercase tracking-tighter">Responsive Breakpoints</h3>
                            </div>
                                    ...
                                    <Wrapper key={row.label} identity={{ displayName: `Breakpoint: ${row.label}`, filePath: "app/debug/zap/atoms/layout/page.tsx", type: "Wrapped Snippet" }}>
                                        <div className="flex items-center justify-between p-2 border border-black bg-zinc-50">
                                            <div className="flex items-center gap-2">
                                                <span className="material-symbols-outlined text-sm text-slate-500">{row.icon}</span>
                                                <span className="text-[11px] font-bold">{row.label}</span>
                                            </div>
                                            <span className="text-[10px] font-dev text-transform-tertiary bg-white border border-black px-1">{row.value}</span>
                                        </div>
                                    </Wrapper>
                                ))}
                            </div>
                    ...
                    <Wrapper identity={{ displayName: "Layout Specs", filePath: "app/debug/zap/layout/page.tsx", type: "Atom/View", architecture: "SYSTEMS // CORE" }}>
                        <div className="border border-black p-4 space-y-3">
                            <h3 className="text-[10px] font-black uppercase tracking-widest border-b border-black pb-2">Layout Specs</h3>
                            {[
                    ...
                    <Wrapper identity={{ displayName: "Grid Extension CTA", filePath: "app/debug/zap/layout/page.tsx", type: "Atom/View", architecture: "SYSTEMS // CORE" }}>
                        <div className="bg-black text-white border border-black p-4">
                            <p className="text-[11px] font-bold italic mb-2">&quot;Need to inspect the grid in your browser?&quot;</p>
