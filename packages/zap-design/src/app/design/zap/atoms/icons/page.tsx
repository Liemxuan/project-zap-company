                    ...
                    <Wrapper identity={{ displayName: "Inspector: Font Implementation", type: "Wrapped Snippet", filePath: "app/debug/zap/atoms/icons/page.tsx" }}>
                        <div className="border border-black p-4 bg-primary/10 space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h3 className="text-label-small font-black uppercase tracking-tighter">Icon Implementation</h3>
                            </div>
                            <div className="space-y-2">
                                <div className="bg-white border border-black p-2">
                                    <p className="text-label-small font-dev text-transform-tertiary text-slate-500 mb-1">LOCAL VARIABLE FONT</p>
                                    <code className="text-label-small break-all block text-slate-800">
                                        /public/icons/material-symbols-outlined-variable.woff2
                                    </code>
                                </div>
                                <div className="bg-zinc-100 border border-black p-2">
                                    <p className="text-label-small font-dev text-transform-tertiary text-slate-500 mb-1">CSS DEFINITION</p>
                    ...
                    <Wrapper identity={{ displayName: "Inspector: Styling Rules", type: "Wrapped Snippet", filePath: "app/debug/zap/atoms/icons/page.tsx" }}>
                        <div className="border border-black p-4 space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h3 className="text-label-small font-black uppercase tracking-tighter">Styling Rules</h3>
                            </div>
                            <div className="grid grid-cols-2 gap-2">
                                <div className="p-2 border border-black bg-zinc-50 text-center">
 <span className="block text-label-small font-dev text-transform-tertiary text-slate-500 ">Weight</span>
                                    <span className="block text-title-small font-black">400</span>
                                </div>
                                <div className="p-2 border border-black bg-zinc-50 text-center">
 <span className="block text-label-small font-dev text-transform-tertiary text-slate-500 ">Optical</span>
                                    <span className="block text-title-small font-black">24px</span>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <p className="text-label-small font-bold uppercase mb-1">Color Tokens</p>
                                <div className="flex items-center justify-between text-label-small border-b border-dashed border-slate-300 pb-1">
                    ...
                    <Wrapper identity={{ displayName: "Inspector: Technical Specs", type: "Wrapped Snippet", filePath: "app/debug/zap/atoms/icons/page.tsx" }}>
                        <div className="border border-black p-4 space-y-3">
                            <h3 className="text-label-small font-black uppercase tracking-tighter mb-4 border-b border-black pb-2">Technical Specs</h3>
                            {[
                    ...
                    <Wrapper identity={{ displayName: "Inspector: Action CTA", type: "Wrapped Snippet", filePath: "app/debug/zap/atoms/icons/page.tsx" }}>
                        <div className="bg-black text-white border border-black p-4">
                            <p className="text-label-medium font-bold italic mb-2">&quot;Need a custom icon that isn&apos;t in the library?&quot;</p>
                            <a className="text-label-small font-black uppercase text-primary underline underline-offset-4" href="#">Submit Request</a>
                        </div>
                    </Wrapper>
                </div>
            }
