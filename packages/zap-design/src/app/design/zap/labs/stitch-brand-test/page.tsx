            ...
            inspectorContent={
                <div className="p-4 space-y-4 text-brand-midnight">
                    <div className="bg-layer-panel border-[length:var(--card-border-width,0px)] border-card-border p-4 shadow-card rounded-card">
                        <h4 className="font-bold uppercase text-label-small mb-2">Phase 3 Complete</h4>
                        ...
                        <div className="max-w-[1440px] mx-auto px-10 flex h-16 items-center justify-between">
                            <div className="flex items-center gap-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-on-surface text-title-small font-bold tracking-tight">SystemCore</h2>
                                </div>
                                <nav className="hidden md:flex items-center gap-8">
                                    <a className="text-body-small font-medium hover:text-primary transition-colors" href="#">Design</a>
                                    <a className="text-body-small font-medium hover:text-primary transition-colors" href="#">Components</a>
                                    <a className="text-body-small font-medium hover:text-primary transition-colors" href="#">Tokens</a>
                                    <a className="text-body-small font-medium hover:text-primary transition-colors" href="#">Showcase</a>
                                </nav>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="relative hidden sm:block text-on-surface-variant">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-title-small"><Icon name="search" size={18} /></span>
                                    <input className="h-9 w-64 rounded-shape-medium border-none bg-surface-variant pl-10 text-body-small focus:ring-2 focus:ring-primary/20 text-on-surface" placeholder="Search system docs..." />
                                </div>
                                <button className="bg-primary text-on-primary text-body-small font-bold h-9 px-5 rounded-shape-medium hover:opacity-90 transition-opacity">
                                    v2.4.0
                                </button>
                            </div>
                        </div>
                        ...
                        <section className="p-6">
                            <div className="relative overflow-hidden rounded-shape-large bg-primary p-12 md:p-24 text-center">
                                <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-8">
                                    ...
                                    <p className="text-on-primary/90 text-title-small md:text-xl font-normal max-w-2xl leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div className="p-6 rounded-shape-medium border-[length:var(--card-border-width,1px)] border-outline bg-surface shadow-elevation-1">
                                    <div className="flex items-center gap-2 mb-6">
                                        ...
                                        <h3 className="font-bold text-title-small">Colors</h3>
                                    </div>
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between p-2 rounded-shape-small bg-surface-variant">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-body-small font-medium">Primary</span>
                                            </div>
                                ...
                                <div className="p-6 rounded-shape-medium border-[length:var(--card-border-width,1px)] border-outline bg-surface shadow-elevation-1">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <h3 className="font-bold text-title-small">Typography</h3>
                                    </div>
                                    <div className="text-center py-4">
                                        <div className="text-6xl font-black mb-2 text-on-surface">Aa</div>
                                        <p className="text-body-small font-bold text-on-surface-variant">ZAP Engine Sans</p>
                                    </div>
                                    <div className="mt-4 space-y-1">
                                        <p className="text-label-small uppercase tracking-widest text-on-surface-variant font-bold">Stack</p>
                                        <p className="text-label-small font-dev text-transform-tertiary bg-surface-variant p-2 rounded-shape-small">var(--font-display)</p>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 rounded-shape-medium border-[length:var(--card-border-width,1px)] border-outline bg-surface shadow-elevation-1 lg:col-span-2">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <h3 className="font-bold text-title-small">Washed Buttons</h3>
                                    </div>
                                    <div className="flex gap-4">
                                        <button className="h-10 px-4 bg-primary text-on-primary rounded-btn font-bold text-body-small shadow-elevation-1 border-[length:var(--btn-border-width,0px)] border-outline">Primary Action</button>
                                        <button className="h-10 px-4 bg-surface border-[length:var(--btn-border-width,1px)] border-outline text-on-surface rounded-btn font-bold text-body-small hover:bg-surface-variant transition-colors">Ghost Hover</button>
                                        <button className="h-10 px-4 bg-surface-variant text-on-surface-variant rounded-btn font-bold text-body-small cursor-not-allowed">Disabled State</button>
                                    </div>
                                </div>
                            </div>
                        </section>
