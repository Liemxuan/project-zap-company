# ⚡ SYSTEM ROUTING MATRIX (DAEMON)

<!-- ⚠️ DYNAMICALLY COMPILED VIA SYNC_AGENT_PROFESSION.TS ⚠️ -->
**Target System:** OLYMPUS
**Strict Profession Lock:** `SECURITY_OFFICER`
...
Based on the [SECURITY_OFFICER] profession bounds, this agent is restricted to the following runtime limits:

| Objective | Bound Engine | Registry Identifier | Trigger Tags |
| :--- | :--- | :--- | :--- |
| **Deep Thinking / Complex Matrix** | Execution Core | `gemini-3.1-pro-preview` | `core-reasoning, complex-logic, fast, zss-enforcement, firewall, compliance` |
| **High-Velocity Tasking** | Specialized Secondary | `gemini-3-flash-preview` | `complex-logic` |
...
- **Integrity Bounds:** Operating strictly within `SOP enforcement, static code analysis, vulnerability checking.` bounds.
- **BYOK Lockout:** This agent is barred from independent OPENAI_API_KEY overwrites to preserve swarm telemetry.

*Compiled dynamically on 2026-03-31T08:00:08.585Z*
