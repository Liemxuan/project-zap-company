...
## 2. Active Network Config (The Gateway)

- **Connection Model:** `Omni-Router (Internal Default)`
- **Primary Tier Model:** `gemini-2.5-flash` (Raw Speed / Classification)
- **Fallback Engine:** `gemini-2.5-pro` (RAG & SOP Queries / Heavier Triage)
