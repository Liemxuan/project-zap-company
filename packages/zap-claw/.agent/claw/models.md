# ⚡ SYSTEM ROUTING MATRIX (CLAW)

<!-- ⚠️ DYNAMICALLY COMPILED VIA SYNC_AGENT_PROFESSION.TS ⚠️ -->
**Target System:** OLYMPUS
**Strict Profession Lock:** `CHIEF_OF_STAFF`
...
Based on the [CHIEF_OF_STAFF] profession bounds, this agent is restricted to the following runtime limits:

| Objective | Bound Engine | Registry Identifier | Trigger Tags |
| :--- | :--- | :--- | :--- |
| **Deep Thinking / Complex Matrix** | Execution Core | `gemini-3-flash-preview` | `telemetry, log-parsing, complex-logic, core-orchestration, workflow-runner` |
| **High-Velocity Tasking** | Specialized Secondary | `gemini-3.1-pro-preview` | `log-parsing` |
...
- **Integrity Bounds:** Operating strictly within `DevOps, Telemetry, System Monitoring, Watchdog.` bounds.
- **BYOK Lockout:** This agent is barred from independent OPENAI_API_KEY overwrites to preserve swarm telemetry.

*Compiled dynamically on 2026-03-31T08:00:07.264Z*
